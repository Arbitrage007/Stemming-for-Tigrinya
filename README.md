...
* It was given as a lecture projet mainly on the objective of *how Stemming works*.
* It is written on jupyter notebook using Anaconda.if you have'nt Anaconda, you can download it from [this](https://www.anaconda.com/).
